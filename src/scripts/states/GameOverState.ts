...
export class GameOverState extends State.AbstractState {
    ...
    constructor(stack: StateStack, context: State.Context) {
        ...
        this.gameTitle = new PIXI.Text("Game Over", gameTitleStyle);
        ...
        this.pressAnyKey = new PIXI.Text("Press any key to restart game", pressAnyKeyStyle);
